...
```{r setupBiomassValid, include=FALSE}
...
```{r moduleInputsBiomassValid, echo = FALSE, eval = TRUE, message = FALSE}
...
```{r moduleParamsBiomassValid, echo = FALSE, eval = TRUE, message = FALSE}
...
```{r moduleOutputsBiomassValid, echo = FALSE, eval = TRUE, message = FALSE}
...
```{r moduleInputs2BiomassValid, echo = FALSE, eval = TRUE, message = FALSE}
...
```{r moduleParams2BiomassValid, echo = FALSE, eval = TRUE, message = FALSE}
...
```{r load-SpaDESBiomassValid, eval=FALSE}
library(SpaDES)
...
```{r module usage example setup BiomassValid, eval = FALSE}
tempDir <- tempdir()
...
```{r  module usage example setup2 BiomassValid, eval = FALSE}
...
```{r module usage example2 BiomassValid, eval=FALSE}
graphics.off()
...
```{r figBiomassValidOutPlots, echo = FALSE, eval = TRUE, fig.show='hold', out.width = "50%", fig.cap = "_Biomass_validationKNN_ automatically generates plots showing a visual comparison between simulated and observed species presences (right) across the landscape, and relative species biomass per pixel (left)."}
knitr::include_graphics(c("figures/LandscapeComparisons_PresAbs.png", "figures/PixelComparisons_relB.png"))
```

```{r figBiomassValidOutPlots2, echo = FALSE, eval = TRUE, fig.show='hold', fig.cap = "A plot of landscape-wide mean absolute deviations (MAD) from (top to bottom) observed mean relative abundance, no. of presences, no. of pixels where the species is dominant and $\\Delta$B."}
knitr::include_graphics(c("figures/landscapeMAD.png"))
```

```{r figBiomassValidOutPlots3, echo = FALSE, eval = TRUE, fig.show='hold', fig.cap = "Diagnostic plot of observed changes in biomass and age $\\Delta$B and $\\Delta$Age, respectively)."}
